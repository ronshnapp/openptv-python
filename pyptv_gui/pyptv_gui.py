...
class TreeMenuHandler (Handler):
    ...
    def track_no_disp_action(self, info):
        ...
        if extern_tracker=='default':
            ...
            print('sequence: ', run_info.get_sequence_range())
...
menu_bar = MenuBar(
                ...
                Menu(
                    Action(name='Select plugin',action='plugin_action'),
                    name='Plugins'
                ),
                Menu(
